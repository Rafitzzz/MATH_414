...
\title{ \normalsize \textsc{}
		\\ [2.0cm]
		\HRule{1.5pt} \\
		\LARGE \textbf{\uppercase{MATH 414: Stochastic Simulation}
...
\section{Pseudo Random Number Generators} \label{sec:sup-learing-basics}
\input{sections/pseudo_rngs.tex}
